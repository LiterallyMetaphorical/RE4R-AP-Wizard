...
internal sealed class MainWindow : Window
{
        ...
        panel.Children.Add(
            new StackPanel
            {
                Children =
                {
                    new TextBlock
                    {
                        Text = "RE4R Archipelago",
                        FontSize = 26,
                        FontWeight = FontWeight.SemiBold,
                    },
                    new TextBlock
                    {
                        Text = "Resident Evil 4 Remake multiworld launcher",
    ...
    {
        _screen.Content = new ScrollViewer
        {
            Content = _viewModel.CurrentScreen switch
            {
                ...
                _ => new TextBlock { Text = "Loading launcher…" },
            },
        };
    }
    ...
    private static Control SetupScreen(SetupViewModel vm)
    {
        ...
        body.Children.Add(StatusCard("Separate Ways", "SeparateWaysStatusLabel", "SeparateWaysStatusText", "SeparateWaysStatusBackground", "SeparateWaysStatusForeground"));
        ...
        body.Children.Add(Button("Continue", "ContinueCommand"));
        return body;
    }
    ...
    private static Control LandingScreen(LandingViewModel vm)
    {
        ...
        var banner = Card("BannerBackground",
            Text("BannerTitle", true, 18),
            Text("BannerBody", true),
            Row(
        ...
        var roles = new StackPanel
        {
            Spacing = 10,
            Children =
            {
                new TextBlock { Text = "Are you organizing this multiworld?", FontSize = 20 },
                Button("Yes — create the multiworld", "StartCreateCommand"),
                Button("No — someone else is organizing", "AnswerSomeoneElseCommand"),
                Button("Create or edit my YAML settings", "StartConfigureYamlCommand"),
                Button("Setup status", "OpenSetupCommand"),
            },
        };
        roles.Bind(IsVisibleProperty, Binding("IsRoleStage"));
        body.Children.Add(roles);
        var join = new StackPanel
        {
            Spacing = 10,
            Children =
            {
                new TextBlock { Text = "Do you already have the room address?", FontSize = 20 },
                Button("Yes — join the room", "StartJoinCommand"),
                Button("Not yet — configure my YAML", "StartConfigureYamlCommand"),
                Button("Back", "BackToRoleQuestionCommand"),
            },
        };
        join.Bind(IsVisibleProperty, Binding("IsAddressStage"));
    ...
    {
        var body = Screen("Configure Player YAML", vm.HeaderDescription, vm);
        ...
        body.Children.Add(Check("Show the in-game getting-started guide", "Tutorial"));
        ...
        body.Children.Add(Row(
            Button("Save YAML", "SaveYamlCommand"),
            Button("Copy YAML", "CopyYamlCommand"),
    ...
    private static Control GenerationScreen(GenerationGuidanceViewModel vm)
    {
        ...
        body.Children.Add(Row(
            Button("Previous step", "BackStepCommand"),
            Button("Next step", "NextStepCommand"),
            Button("Back to launcher", "BackToLandingCommand")));
        return body;
    }
    ...
    private static Control JoinScreen(JoinFlowViewModel vm)
    {
        ...
        body.Children.Add(Row(
            ...
            Button("Patch my game", "PatchMyGameCommand")));
        body.Children.Add(Text("StatusText", true));
        return body;
    }
    ...
    private static Control PatchScreen(PatchLaunchViewModel vm)
    {
        ...
        body.Children.Add(Row(
            ...
            Button("Retry", "RetryCommand", "ShowRetry"),
            Button("Back", "BackToLandingCommand")));
        return body;
    }
